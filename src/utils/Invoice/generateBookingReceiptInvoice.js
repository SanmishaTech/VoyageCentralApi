 ...
 */
const generateBookingReceiptInvoice = async (invoiceData, filePath) => {
  ...
  const {
    ...
    agencyDetails, // { name, addressLines (array), city, pincode, gstinUin, email, logoPath (optional) }
  ...
  // Company details from image (can be passed in agencyDetails or hardcoded/configured elsewhere)
  const companyDetails = agencyDetails || {
    ...
    email: "agencyDetails.ho@gmail.com",
  };
...
module.exports = { generateBookingReceiptInvoice };
