  ...
  try {
    const newHotel = await prisma.hotel.create({
      data: {
        ...
        contactPersonName2: req.body.contactPersonName2,
        contactPersonEmail2: req.body.contactPersonEmail2,
        contactPersonMobile2: req.body.contactPersonMobile2,
  ...
  try {
    ...
    if (
      ...
      return res.status(409).json({
        errors: {
          message:
            "Cannot delete this Hotel because it is referenced in related data. Please remove the related references before deleting.",
        },
      });
    }
    if (error.code === "P2025") {
