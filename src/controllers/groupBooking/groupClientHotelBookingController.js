...
const createGroupClientHotelBooking = async (req, res) => {
...
const getGroupClientHotelBookingById = async (req, res) => {
...
const updateGroupClientHotelBooking = async (req, res) => {
  const schema = z.object({
    partyComingFrom: z.string().min(1, "party coming from field is required."),
  });
...
const deleteGroupClientHotelBooking = async (req, res) => {
  const { hotelBookingId } = req.params;
...
const getAllHotelBookingsByGroupClientBookingId = async (req, res) => {
  const { groupClientBookingId } = req.params;
